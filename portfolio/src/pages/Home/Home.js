  ...
  return (
    ...
    <div>
      ...
      <ul>
        ...
        <a href="https://github.com/gharmon327"><img src={github} alt="github" height="50px" width="50px"/></a>
        <a href="https://www.linkedin.com/in/gregjharmon/"><img src={linkedin} alt="linkedIN" height="50px" width="50px"/></a>
    </div>
    </>
  );
}
