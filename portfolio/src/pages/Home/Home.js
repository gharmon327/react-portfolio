...
export default function Home(){
    return (
        ...
        <h2>Contact Me</h2>
        <ul>
            <li><b>Email:</b> GHarmon327@gmail.com</li>
            <li><b>Location:</b> South Carolina(Open to Relocation)</li>
        </ul>
